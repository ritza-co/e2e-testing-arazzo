...
- [`activationActivateRobot`](docs/sdks/activation/README.md#activaterobot) - Activate the robot
- [`assemblyAssembleRobot`](docs/sdks/assembly/README.md#assemblerobot) - Assemble the robot
- [`featuresConfigureRobotFeatures`](docs/sdks/features/README.md#configurerobotfeatures) - Configure features of the robot
- [`featuresGetRobotFeatures`](docs/sdks/features/README.md#getrobotfeatures) - Get robot's features
- [`partsAddRobotParts`](docs/sdks/parts/README.md#addrobotparts) - Add parts to the robot
- [`partsGetRobotParts`](docs/sdks/parts/README.md#getrobotparts) - Get robot's parts
- [`robotsCreateRobot`](docs/sdks/robots/README.md#createrobot) - Create a new robot design session
- [`robotsGetRobot`](docs/sdks/robots/README.md#getrobot) - Get robot details
- [`robotsListRobots`](docs/sdks/robots/README.md#listrobots) - List all robots
...
In addition, when custom error responses are specified for an operation, the SDK may throw their associated Error type. You can refer to respective *Errors* tables in SDK docs for more details on possible error types for each operation. For example, the `listRobots` method may throw the following errors:
